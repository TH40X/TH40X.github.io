import {
  ...
  warning,
  warning_default
} from "./chunk-YZONRVWU.js";
import {
  _defineProperty,
  _extends,
  _toPropertyKey,
  _typeof
} from "./chunk-2AFODGK4.js";
import {
  require_classnames
...
function useCacheToken(theme, tokens) {
  ...
  var tokenStr = React6.useMemo(function() {
    return flattenToken(mergedToken);
  }, [mergedToken]);
  var overrideTokenStr = React6.useMemo(function() {
...
var LocaleProvider = (props) => {
  ...
  const getMemoizedContextValue = React10.useMemo(() => Object.assign(Object.assign({}, locale4), {
    exist: true
  }), [locale4]);
...
var ConfigContext = React15.createContext({
...
var DisabledContext = React16.createContext(false);
var DisabledContextProvider = (_ref) => {
  let {
    children,
    disabled
  } = _ref;
  const originDisabled = React16.useContext(DisabledContext);
  return React16.createElement(DisabledContext.Provider, {
...
var SizeContext = React17.createContext(void 0);
var SizeContextProvider = (_ref) => {
  let {
    children,
    size
  } = _ref;
  const originSize = React17.useContext(SizeContext);
  return React17.createElement(SizeContext.Provider, {
...
var Context = React19.createContext({});
...
var useDomMotionEvents_default = function(callback) {
  ...
  var onInternalMotionEnd = React21.useCallback(function(event) {
...
var useNextFrame_default = function() {
  var nextFrameRef = React22.useRef(null);
...
function useStatus(supportMotion, visible, getElement, _ref) {
  ...
  var firstMountChangeRef = React24.useRef(false);
  (0, import_react11.useEffect)(function() {
    if (asyncVisible) {
...
function genCSSMotion(config) {
  ...
  var CSSMotion = React25.forwardRef(function(props, ref) {
    var _props$visible = props.visible, visible = _props$visible === void 0 ? true : _props$visible, _props$removeOnLeave = props.removeOnLeave, removeOnLeave = _props$removeOnLeave === void 0 ? true : _props$removeOnLeave, forceRender = props.forceRender, children = props.children, motionName = props.motionName, leavedClassName = props.leavedClassName, eventProps = props.eventProps;
    var _React$useContext = React25.useContext(Context), contextMotion = _React$useContext.motion;
    ...
    var renderedRef = React25.useRef(mergedVisible);
    if (mergedVisible) {
      renderedRef.current = true;
    }
    var setNodeRef = React25.useCallback(function(node2) {
    ...
    if (React25.isValidElement(motionChildren) && supportRef(motionChildren)) {
      var _ref = motionChildren, originNodeRef = _ref.ref;
      if (!originNodeRef) {
        motionChildren = React25.cloneElement(motionChildren, {
          ref: setNodeRef
        });
      }
    }
    return React25.createElement(DomWrapper_default, {
      ref: wrapperNodeRef
    }, motionChildren);
  });
  ...
  var CSSMotionList = function(_React$Component) {
    ...
    _createClass(CSSMotionList2, [{
      ...
      value: function render() {
        ...
        var Component3 = component || React26.Fragment;
        var motionProps = {};
        ...
        return React26.createElement(Component3, restProps, keyEntities.map(function(_ref2, index) {
          var status = _ref2.status, eventProps = _objectWithoutProperties(_ref2, _excluded22);
          var visible = status === STATUS_ADD || status === STATUS_KEEP;
          return React26.createElement(CSSMotion, _extends({}, motionProps, {
            key: eventProps.key,
            visible,
            eventProps,
...
function MotionWrapper(props) {
  ...
  const needWrapMotionProviderRef = React27.useRef(false);
  needWrapMotionProviderRef.current = needWrapMotionProviderRef.current || motion === false;
  if (needWrapMotionProviderRef.current) {
    return React27.createElement(MotionProvider, {
      motion
    }, children);
  }
  return children;
...
var PropWarning = React28.memo((_ref) => {
  let {
...
var ProviderChildren = (props) => {
  ...
  const getPrefixCls = React29.useCallback((suffixCls, customizePrefixCls) => {
    const {
      prefixCls
    } = props;
    if (customizePrefixCls) {
  ...
  const memoIconContextValue = React29.useMemo(() => ({
    prefixCls: iconPrefixCls,
    csp
  }), [iconPrefixCls, csp]);
  let childNode = React29.createElement(React29.Fragment, null, React29.createElement(PropWarning_default, {
    dropdownMatchSelectWidth
  }), children);
  const validateMessages = React29.useMemo(() => {
    var _a, _b, _c, _d;
  ...
  if (Object.keys(validateMessages).length > 0) {
    childNode = React29.createElement(validateMessagesContext_default.Provider, {
      value: validateMessages
    }, childNode);
  }
  if (locale4) {
    childNode = React29.createElement(locale_default, {
      locale: locale4,
      _ANT_MARK__: ANT_MARK
    }, childNode);
  }
  if (iconPrefixCls || csp) {
    childNode = React29.createElement(Context_default.Provider, {
      value: memoIconContextValue
    }, childNode);
  }
  if (componentSize) {
    childNode = React29.createElement(SizeContextProvider, {
      size: componentSize
    }, childNode);
  }
  childNode = React29.createElement(MotionWrapper, null, childNode);
  ...
  if (theme) {
    childNode = React29.createElement(DesignTokenContext.Provider, {
      value: memoTheme
    }, childNode);
  }
  if (componentDisabled !== void 0) {
    childNode = React29.createElement(DisabledContextProvider, {
      disabled: componentDisabled
    }, childNode);
  }
  return React29.createElement(ConfigContext.Provider, {
    value: memoedConfig
  }, childNode);
};
var ConfigProvider = (props) => {
  const context = React29.useContext(ConfigContext);
  const antLocale = React29.useContext(context_default);
  return React29.createElement(ProviderChildren, Object.assign({
...
var style_default = genComponentStyleHook("Layout", (token2) => [genLayoutStyle(token2)], (token2) => {
  const {
    colorBgLayout,
    controlHeight,
    controlHeightLG,
...
var LayoutContext = React30.createContext({
  siderHook: {
    addSider: () => null,
    removeSider: () => null
  }
...
function generator(_ref) {
  ...
  return (BasicComponent) => {
    const Adapter = React30.forwardRef((props, ref) => React30.createElement(BasicComponent, Object.assign({
      ref,
      suffixCls,
      tagName
    }, props)));
...
var Basic = React30.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    suffixCls,
    className,
    tagName: TagName
  } = props, others = __rest4(props, ["prefixCls", "suffixCls", "className", "tagName"]);
  const {
    getPrefixCls
  ...
  return wrapSSR(React30.createElement(TagName, Object.assign({
    className: (0, import_classnames2.default)(customizePrefixCls || prefixWithSuffixCls, className, hashId),
    ref
  }, others)));
});
var BasicLayout = React30.forwardRef((props, ref) => {
  const {
    direction
  } = React30.useContext(ConfigContext);
  const [siders, setSiders] = React30.useState([]);
  const {
    prefixCls: customizePrefixCls,
    className,
    rootClassName,
    ...
    tagName: Tag,
    style: style2
  } = props, others = __rest4(props, ["prefixCls", "className", "rootClassName", "children", "hasSider", "tagName", "style"]);
  ...
  return wrapSSR(React30.createElement(LayoutContext.Provider, {
    value: contextValue
  }, React30.createElement(Tag, Object.assign({
    ref,
...
//# sourceMappingURL=chunk-DQ3G7FKZ.js.map
