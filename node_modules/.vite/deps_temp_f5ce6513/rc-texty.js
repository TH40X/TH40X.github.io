import {
  ...
  polyfill,
  require_prop_types
} from "./chunk-3U46FIME.js";
import {
  require_classnames
} from "./chunk-XBKNWCRJ.js";
import {
  require_react_dom
...
var require_main = __commonJS({
  "node_modules/style-utils/main.js"(exports) {
    ...
    exports.toCssLowerCase = toCssLowerCase2;
    exports.toStyleUpperCase = toStyleUpperCase;
    exports.toFixed = toFixed2;
    exports.createMatrix = createMatrix3;
    exports.checkStyleName = checkStyleName3;
    exports.getGsapType = getGsapType3;
    ...
    var _hue = function _hue2(hh, m1, m2) {
      var h = hh > 1 ? hh - 1 : hh;
      h = hh < 0 ? hh + 1 : h;
    ...
    function checkStyleName3(p5) {
      if (typeof document === "undefined") {
        return null;
      }
      var a = ["O", "Moz", "ms", "Ms", "Webkit"];
      if (p5 !== "filter" && p5 in document.body.style) {
        return p5;
      }
      var _p = p5.charAt(0).toUpperCase() + p5.substr(1);
      var prefixCss = a.filter(function(key) {
        return "" + key + _p in document.body.style;
      });
      return prefixCss[0] ? "" + prefixCss[0] + _p : null;
    }
    function getGsapType3(_p) {
      var p5 = _p;
      p5 = p5 === "x" ? "translateX" : p5;
      p5 = p5 === "y" ? "translateY" : p5;
      p5 = p5 === "z" ? "translateZ" : p5;
      return p5;
    }
    function parseColor3(_v) {
      var a = void 0;
      var r = void 0;
      var g = void 0;
      var b = void 0;
    ...
    function isTransform3(p5) {
      return cssList2._lists.transformsBase.indexOf(p5) >= 0 ? "transform" : p5;
    }
    function isConvert2(p5) {
      var cssName = isTransform3(p5);
    ...
    function getTransform2(transform) {
      ...
      var cos = void 0;
      var sin = void 0;
      tm.rotateX = toFixed2(angle * RAD2DEG) || 0;
      if (angle) {
        cos = Math.cos(-angle);
        sin = Math.sin(-angle);
        t1 = m21 * cos + m31 * sin;
      ...
      tm.rotateY = toFixed2(angle * RAD2DEG) || 0;
      if (angle) {
        cos = Math.cos(-angle);
        sin = Math.sin(-angle);
        t1 = m11 * cos - m31 * sin;
      ...
      tm.rotate = toFixed2(angle * RAD2DEG) || 0;
      if (angle) {
        cos = Math.cos(angle);
        sin = Math.sin(angle);
        t1 = m11 * cos + m12 * sin;
      ...
      tm.scaleX = toFixed2(Math.sqrt(m11 * m11 + m12 * m12 + m13 * m13));
      tm.scaleY = toFixed2(Math.sqrt(m22 * m22 + m23 * m23));
      tm.scaleZ = toFixed2(Math.sqrt(m31 * m31 + m32 * m32 + m33 * m33));
    ...
    function getUnit(p5, v) {
      var currentUnit = v && v.toString().replace(/[^a-z|%]/ig, "");
      var unit = "";
      if (p5.indexOf("translate") >= 0 || p5.indexOf("perspective") >= 0 || p5.indexOf("blur") >= 0) {
        unit = "px";
      } else if (p5.indexOf("skew") >= 0 || p5.indexOf("rotate") >= 0) {
        unit = "deg";
      }
      return currentUnit || unit;
    }
    function getValues(p5, d, u) {
      return p5 + "(" + d + (u || "") + ")";
    }
    ...
    var tweenFunctions = {
      ...
      easeInElastic: function(t, b, _c, d) {
        ...
        if (a < Math.abs(c)) {
          ...
          s = p5 / (2 * Math.PI) * Math.asin(c / a);
        }
        return -(a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * d - s) * (2 * Math.PI) / p5)) + b;
      },
      easeOutElastic: function(t, b, _c, d) {
        ...
        return a * Math.pow(2, -10 * t) * Math.sin((t * d - s) * (2 * Math.PI) / p5) + c + b;
      },
      easeInOutElastic: function(t, b, _c, d) {
        ...
        if (t < 1) {
          return -0.5 * (a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * d - s) * (2 * Math.PI) / p5)) + b;
        } else {
          return a * Math.pow(2, -10 * (t -= 1)) * Math.sin((t * d - s) * (2 * Math.PI) / p5) * 0.5 + c + b;
        }
      },
...
function toArrayChildren(children) {
  var ret = [];
  import_react.default.Children.forEach(children, function(c) {
    ret.push(c);
  });
  return ret;
}
...
import_tween_functions.default.path = function(_path, _param) {
  ...
  return function path(t, b, _c, d) {
    var p5 = import_tween_functions.default.linear(t, b, _c, d);
    var timePointX = rect * p5;
    var point = points.filter(function(item) {
      return item.x >= timePointX;
    })[0] || pathNode.getPointAtLength(p5 * pathLength);
    return 1 - point.y / rect;
  };
};
var easing_default = import_tween_functions.default;

// node_modules/rc-tween-one/es/plugins.js
var Plugins = function Plugins2() {
};
var p = Plugins.prototype;
p.push = function(plugin) {
  this[plugin.prototype.name] = plugin;
};
var plugins_default = new Plugins();
...
var StylePlugin = function StylePlugin2(target, vars, type) {
  this.target = target;
  this.vars = vars;
  this.type = type;
  this.propsData = {};
...
var p2 = StylePlugin.prototype;
p2.getTweenData = function(key, $vars) {
  var data = {
    data: {},
    dataType: {},
    dataUnit: {},
  ...
  if (key.match(/colo|fill|storker/i)) {
    data.data[key] = (0, import_style_utils.parseColor)(vars);
    data.dataType[key] = "color";
  } else if (key === "strokeDasharray") {
    data.data[key] = vars.split(",");
    data.dataType[key] = "strokeDasharray";
  } else if (key.match(/shadow/i)) {
    data.data[key] = (0, import_style_utils.parseShadow)(vars);
...
p2.setDefaultData = function() {
  ...
  Object.keys(this.vars).forEach(function(_key) {
    if (_key in plugins_default) {
      _this.propsData.data[_key] = new plugins_default[_key](_this.target, _this.vars[_key]);
      return;
    }
    var key = (0, import_style_utils.getGsapType)(_key);
...
p2.convertToMarksArray = function(computedStyle, unit, key, data, i) {
...
p2.getAnimStart = function(computedStyle, tween, isSvg) {
  var _this2 = this;
  var style = {};
  var tweenStyle = tween.style || {};
  var transform = void 0;
  Object.keys(this.propsData.data).forEach(function(key) {
    var cssName = (0, import_style_utils.isConvert)(key);
    ...
    if (key in plugins_default) {
      if (key === "bezier") {
        _this2.transform = (0, import_style_utils.checkStyleName)("transform");
        startData = computedStyle[isSvg ? "transformSVG" : _this2.transform];
        transform = transform || (tweenStyle.transform ? (0, import_extends.default)({}, tweenStyle.transform) : style.transform || (0, import_style_utils.getTransform)(startData));
      ...
      if (tweenStyle[cssName]) {
        ...
        _this2.filterName = (0, import_style_utils.checkStyleName)("filter") || "filter";
        startData = computedStyle[_this2.filterName];
        _this2.filterObject = (0, import_extends.default)({}, _this2.filterObject, (0, import_style_utils.splitFilterToObject)(startData));
      ...
      style[cssName] = (0, import_style_utils.parseColor)(startData);
    } else if (key.match(/shadow/i)) {
      startData = (0, import_style_utils.parseShadow)(startData);
      endUnit = _this2.propsData.dataUnit[key];
...
p2.setArrayRatio = function(ratio, start, vars, unit, type) {
  ...
  if (type === "color") {
    return (0, import_style_utils.getColor)(_vars);
  } else if (type === "shadow") {
    ...
    var color = (0, import_style_utils.getColor)(c);
    return (s.join(" ") + " " + color + " " + (endInset ? "inset" : "")).trim();
  }
  return _vars;
};
p2.setRatio = function(ratio, tween, computedStyle) {
  var _this3 = this;
  tween.style = tween.style || {};
  if (this.start.transform) {
    tween.style.transform = tween.style.transform || (0, import_extends.default)({}, this.start.transform);
  }
  var style = this.target.style;
  Object.keys(this.propsData.data).forEach(function(key) {
    var _isTransform = (0, import_style_utils.isTransform)(key) === "transform";
    ...
    if (key in plugins_default) {
      ...
      style[_this3.transform] = getTransformValue(tween.style.transform);
      if (computedStyle) {
        computedStyle.transformSVG = (0, import_style_utils.createMatrix)(style[_this3.transform]).toString();
      }
      return;
      ...
      var styleUnit = (0, import_style_utils.stylesToCss)(key, 0);
      styleUnit = typeof styleUnit === "number" ? "" : styleUnit.replace(/[^a-z|%]/g, "");
      unit = unit || (import_style_utils.cssList.filter.indexOf(key) >= 0 ? "" : styleUnit);
    ...
    if (import_style_utils.cssList.filter.indexOf(key) >= 0) {
...
var StylePlugin_default = StylePlugin;
...
function defaultData(vars, now) {
  ...
  return {
    ...
    ease: typeof vars.ease === "function" ? vars.ease : easing_default[vars.ease || DEFAULT_EASING],
...
var Tween = function Tween2(target, to, attr) {
...
var p3 = Tween.prototype;
p3.setAttrIsStyle = function() {
  var _this = this;
  var data = [];
  var defaultParam = defaultData({}, 0);
  this.data.forEach(function(d, i) {
    var _d = (0, import_extends2.default)({}, d);
    if (_this.attr === "style") {
      data[i] = {};
      ...
      Object.keys(_d).forEach(function(key) {
        ...
        if (key === "bezier") {
          _d.style = (0, import_extends2.default)({}, _d.style, { bezier: _d[key] });
          delete _d[key];
          _this.startDefaultData.style = _this.target.getAttribute("style") || "";
        } else {
          if (key in defaultParam) {
...
p3.setDefaultData = function(_vars) {
  var _this2 = this;
  var now = 0;
  var repeatMax = false;
  var data = _vars.map(function(item) {
    ...
    Object.keys(item).forEach(function(_key) {
      if (!(_key in tweenData)) {
        var _data = item[_key];
        if (_key in plugins_default) {
          tweenData.vars[_key] = new plugins_default[_key](_this2.target, _data, tweenData.type);
        } else if ((_key === "d" || _key === "points") && "SVGMorph" in plugins_default) {
          tweenData.vars[_key] = new plugins_default.SVGMorph(_this2.target, _data, _key);
        } else if (_key.match(/color/i) || _key === "stroke" || _key === "fill") {
          tweenData.vars[_key] = { type: "color", vars: (0, import_style_utils2.parseColor)(_data) };
    ...
    if (transform === "none") {
      ...
      if (attrStyle && attrStyle.indexOf("transform:") >= 0) {
        transform = attrStyle.split(";").filter(function(k) {
          ...
          return (0, import_style_utils2.createMatrix)(item.split(":")[1].trim()).toString();
        })[0];
...
p3.getAnimStartData = function(item) {
  var _this3 = this;
  var start = {};
  Object.keys(item).forEach(function(_key) {
    if (_key in plugins_default || _this3.attr === "attr" && (_key === "d" || _key === "points")) {
      _this3.computedStyle = _this3.computedStyle || (!_this3.target.getAttribute ? (0, import_extends2.default)({}, _this3.target) : _this3.getComputedStyle());
    ...
    if (_this3.attr === "attr") {
      ...
      if (_key.match(/color/i) || _key === "stroke" || _key === "fill") {
        ...
        data = (0, import_style_utils2.parseColor)(data);
        start[_key] = data;
...
p3.setAnimData = function(data) {
  var _this4 = this;
  Object.keys(data).forEach(function(key) {
    if (key in plugins_default || _this4.attr === "attr" && (key === "d" || key === "points")) {
      return;
    }
    _this4.target[key] = data[key];
  });
};
p3.setRatio = function(ratio, endData, i) {
  var _this5 = this;
  Object.keys(endData.vars).forEach(function(_key) {
    if (_key in plugins_default || _this5.attr === "attr" && (_key === "d" || _key === "points")) {
    ...
    if (_this5.attr === "attr") {
      if (!endVars.type) {
        ...
        _this5.setValue(_key, (0, import_style_utils2.getColor)(data));
      }
    }
  });
  this.setAnimData(this.tween);
};
p3.getValue = function(key) {
  return this.target.getAttribute ? this.target.getAttribute(key) : this.target[key];
};
p3.setValue = function(key, value) {
...
p3.render = function() {
  ...
  this.defaultData.forEach(function(item, i) {
    ...
    var duration = (0, import_style_utils2.toFixed)(item.duration);
    ...
    var progressTime = (0, import_style_utils2.toFixed)(_this6.progressTime - initTime);
    var ratio = void 0;
    ...
    var cb = (0, import_extends2.default)({
      ...
      if ((progressTime >= duration - _this6.accuracy && !reverse || reverse && progressTime <= 0) && repeatNum >= item.repeat) {
        ...
        if ((!item.reset || item.reset && progressTime >= duration) && !updateAnim) {
          if (duration < maxPer) {
            ...
            item.onUpdate((0, import_extends2.default)({ ratio }, e));
            cb.mode = "onUpdate";
            _this6.onChange(cb);
          }
          item.onComplete(e);
        ...
        if (!updateAnim) {
          if (item.repeat && repeatNum > 0 && item.currentRepeat !== repeatNum) {
            ...
            item.onRepeat((0, import_extends2.default)({}, e, { repeatNum }));
...
p3.init = p3.frame;
p3.resetAnimData = function() {
  this.tween = {};
  this.start = {};
};
var getDefaultStyle = function getDefaultStyle2(domStyle, defaultStyle, tweenData) {
  var $data = defaultData({}, 0);
  var getStyleToArray = function getStyleToArray2(styleString) {
  ...
  tweenData.forEach(function(value) {
    Object.keys(value).forEach(function(name) {
      if (!(name in $data)) {
        ...
        var styleName = (0, import_style_utils2.toCssLowerCase)((0, import_style_utils2.isTransform)((0, import_style_utils2.getGsapType)($name)));
...
p3.reStart = function(style, preStyle, isTween) {
  var _this9 = this;
  this.start = {};
  this.tween = {};
  Object.keys(style || {}).forEach(function(key) {
    if (isTween || !preStyle || style[key] !== preStyle[key]) {
      _this9.target.style[key] = (0, import_style_utils2.stylesToCss)(key, style[key]);
    }
  });
  this.setAttrIsStyle();
...
var tickObjToArray = function tickObjToArray2(obj) {
...
p4.wake = function(key, fn) {
  this.tickKeyObject[key] = fn;
  this.tickFnArray = tickObjToArray(this.tickKeyObject);
  if (this.id === -1) {
    this.id = (0, import_raf.default)(this.tick);
  }
};
p4.clear = function(key) {
  delete this.tickKeyObject[key];
  this.tickFnArray = tickObjToArray(this.tickKeyObject);
};
p4.sleep = function() {
  import_raf.default.cancel(this.id);
  this.id = -1;
  this.frame = 0;
};
...
p4.tick = function(a) {
  ...
  ticker.id = (0, import_raf.default)(ticker.tick);
};
var timeoutIdNumber = 0;
p4.timeout = function(fn, time) {
  var _this = this;
...
var perFrame = Math.round(1e3 / 60);
var objectOrArray = import_prop_types.default.oneOfType([import_prop_types.default.object, import_prop_types.default.array]);
var TweenOne = function(_Component) {
  (0, import_inherits.default)(TweenOne2, _Component);
  (0, import_createClass.default)(TweenOne2, null, [{
      ...
      if (prevProps && props !== prevProps) {
        ...
        if (typeof nextMoment === "number" && nextMoment !== prevProps.moment) {
          if ($self.tween && !$self.updateAnim) {
            ...
            $self.startTime = ticker_default.time;
            if (props.paused) {
              $self.raf();
            }
        ...
        if ($self.paused !== props.paused || $self.reverse !== props.reverse) {
          ...
          if ($self.paused) {
            ...
            $self.cancelRequestAnimationFrame();
            ticker_default.timeout($self.restart, props.reverseDelay);
          } else {
            if ($self.tween) {
  ...
  function TweenOne2(props) {
    (0, import_classCallCheck.default)(this, TweenOne2);
    var _this = (0, import_possibleConstructorReturn.default)(this, (TweenOne2.__proto__ || Object.getPrototypeOf(TweenOne2)).call(this, props));
  ...
  (0, import_createClass.default)(TweenOne2, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      this.dom = import_react_dom.default.findDOMNode(this);
    ...
    value: function render() {
      ...
      if (!component && typeof children !== "string") {
        ...
        var newStyle = (0, import_extends3.default)({}, childStyle, props.style);
        var newClassName = className ? className + " " + childClass : childClass;
        return import_react2.default.cloneElement(children, { style: newStyle, ref: refFunc, className: newClassName });
      }
      return import_react2.default.createElement(component, (0, import_extends3.default)({
        ref: refFunc
...
TweenOne.propTypes = {
  ...
  componentProps: import_prop_types.default.any,
  animation: objectOrArray,
  children: import_prop_types.default.any,
  style: import_prop_types.default.object,
  paused: import_prop_types.default.bool,
  reverse: import_prop_types.default.bool,
  reverseDelay: import_prop_types.default.number,
  yoyo: import_prop_types.default.bool,
  repeat: import_prop_types.default.number,
  moment: import_prop_types.default.number,
  attr: import_prop_types.default.string,
  onChange: import_prop_types.default.func,
  resetStyle: import_prop_types.default.bool,
  forcedJudg: import_prop_types.default.object
};
...
var _initialiseProps = function _initialiseProps2() {
  ...
  this.setDefault = function(props) {
    ...
    _this3.startTime = ticker_default.time;
  };
  ...
  this.start = function() {
    ...
    if (props.animation && Object.keys(props.animation).length) {
      ...
      _this3.tween = new Tween_default(_this3.dom, props.animation, props.attr);
      _this3.tween.reverse = _this3.reverse;
      _this3.raf();
      _this3.play();
    } else {
  ...
  this.play = function() {
    ...
    _this3.rafID = ticker_default.add(_this3.raf);
  };
  this.frame = function() {
    ...
    var moment = ticker_default.time - _this3.startTime + _this3.startMoment;
    if (_this3.reverse) {
      moment = (_this3.startMoment || 0) - (ticker_default.time - _this3.startTime);
    }
    ...
    _this3.tween.onChange = function(e) {
      var cb = (0, import_extends3.default)({}, e, {
        timelineMode: ""
      });
  ...
  this.cancelRequestAnimationFrame = function() {
    ticker_default.clear(_this3.rafID);
    _this3.rafID = -1;
  };
};
TweenOne.isTweenOne = true;
var TweenOne_default = polyfill(TweenOne);
...
var TweenOneGroup = function(_Component) {
  (0, import_inherits2.default)(TweenOneGroup3, _Component);
  (0, import_createClass2.default)(TweenOneGroup3, null, [{
    key: "getDerivedStateFromProps",
    value: function getDerivedStateFromProps(props, _ref) {
      var prevProps = _ref.prevProps, $self = _ref.$self;
      var nextState = {
  ...
  function TweenOneGroup3(props) {
    (0, import_classCallCheck2.default)(this, TweenOneGroup3);
    var _this = (0, import_possibleConstructorReturn2.default)(this, (TweenOneGroup3.__proto__ || Object.getPrototypeOf(TweenOneGroup3)).call(this, props));
  ...
  (0, import_createClass2.default)(TweenOneGroup3, [{
    key: "componentDidMount",
    value: function componentDidMount() {
    ...
    value: function changeChildren(nextChildren, currentChildren) {
      ...
      nextChildren.forEach(function(c) {
        ...
        if (_this2.saveTweenTag[key]) {
          _this2.saveTweenTag[key] = import_react3.default.cloneElement(_this2.saveTweenTag[key], {}, c);
        }
        if (!hasPrev && key) {
    ...
    value: function render() {
      ...
      var _props = this.props, component = _props.component, componentProps = _props.componentProps, appear = _props.appear, enter = _props.enter, leave = _props.leave, animatingClassName = _props.animatingClassName, onEnd = _props.onEnd, exclusive = _props.exclusive, resetStyle = _props.resetStyle, props = (0, import_objectWithoutProperties2.default)(_props, ["component", "componentProps", "appear", "enter", "leave", "animatingClassName", "onEnd", "exclusive", "resetStyle"]);
      if (!component) {
        return childrenToRender[0] || null;
      }
      return (0, import_react3.createElement)(component, (0, import_extends4.default)({}, props, componentProps), childrenToRender);
    }
  }]);
  return TweenOneGroup3;
...
var _initialiseProps3 = function _initialiseProps4() {
  ...
  this.getTweenChild = function(child) {
    ...
    var key = child.key;
    _this3.saveTweenTag[key] = import_react3.default.createElement(TweenOne_default, (0, import_extends4.default)({}, props, {
      key,
      component: null
    }), child);
...
TweenOneGroup.propTypes = {
  ...
  componentProps: import_prop_types2.default.object,
  children: import_prop_types2.default.any,
  style: import_prop_types2.default.object,
  appear: import_prop_types2.default.bool,
  enter: import_prop_types2.default.any,
  leave: import_prop_types2.default.any,
  animatingClassName: import_prop_types2.default.array,
  onEnd: import_prop_types2.default.func,
  resetStyle: import_prop_types2.default.bool,
  exclusive: import_prop_types2.default.bool
};
...
var TweenOneGroup_default = polyfill(TweenOneGroup);

// node_modules/rc-tween-one/es/index.js
TweenOne_default.TweenOneGroup = TweenOneGroup_default;
TweenOne_default.easing = easing_default;
TweenOne_default.plugins = plugins_default;
TweenOne_default.ticker = ticker_default;
TweenOne_default.Tween = Tween_default;
var TweenOneGroup2 = TweenOneGroup_default;
...
var __rest = function(s, e) {
  ...
  if (s != null && typeof Object.getOwnPropertySymbols === "function")
    for (var i = 0, p5 = Object.getOwnPropertySymbols(s); i < p5.length; i++) {
      if (e.indexOf(p5[i]) < 0)
        t[p5[i]] = s[p5[i]];
    }
  return t;
};
function transformArguments2(arg, e) {
  var result = void 0;
  if (typeof arg === "function") {
    result = arg(e);
  } else {
...
var TextyAnim = function(_React$Component) {
  (0, import_inherits3.default)(TextyAnim2, _React$Component);
  function TextyAnim2() {
    (0, import_classCallCheck3.default)(this, TextyAnim2);
    var _this = (0, import_possibleConstructorReturn3.default)(this, _React$Component.apply(this, arguments));
    _this.getChildrenToRender = function(str) {
      if (!str) {
        return [];
      }
      var split = _this.props.split;
      var t = split ? split(str) : str.split("");
      return t.map(function(c, i) {
        return React4.createElement("span", { key: c + "-" + i.toString() }, c);
      });
    };
    _this.getEnterOrLeave = function(e, genre, length) {
      var _this$props = _this.props, mode = _this$props.mode, type = _this$props.type, enter = _this$props.enter, appear = _this$props.appear, interval = _this$props.interval, duration = _this$props.duration;
      if (!appear && genre === "enter" || length < 0) {
        return null;
      }
      var cb = (0, import_extends5.default)({}, e, { type: genre });
      var $duration = transformArguments2(duration, cb);
      var $interval = transformArguments2(interval, cb);
      var delay = void 0;
      ...
      delay += transformArguments2(_this.props.delay, cb);
      var genreType = genre === "enter" ? "from" : "to";
      var custom = _this.props[genre] || enter;
      if (custom && typeof custom === "function") {
        custom = custom((0, import_extends5.default)({}, e, { delay }));
      } else if (!custom) {
        custom = animTypes_default[type];
      }
      if (custom.enter) {
        ...
        return custom.map(function(item, i) {
          if (!i && (!item.duration || item.type === "set")) {
            ...
            if (!preItem.duration || item.type === "set") {
              return (0, import_extends5.default)({ delay }, item);
            }
          }
          return (0, import_extends5.default)({ delay: !i ? delay : 0 }, item);
        });
      }
      return (0, import_extends5.default)({ delay, duration: $duration, type: genreType }, custom);
    };
    return _this;
  }
  TextyAnim2.prototype.render = function render() {
    var _classnames, _this2 = this;
    var _a = this.props, prefixCls = _a.prefixCls, type = _a.type, className = _a.className, enter = _a.enter, mode = _a.mode, duration = _a.duration, delay = _a.delay, interval = _a.interval, children = _a.children, split = _a.split, props = __rest(_a, ["prefixCls", "type", "className", "enter", "mode", "duration", "delay", "interval", "children", "split"]);
    var getChildrenToRender = this.getChildrenToRender(children);
    var classNames = (0, import_classnames.default)(prefixCls, (_classnames = {}, _classnames[type] = type && !enter, _classnames[className] = !!className, _classnames));
    return React4.createElement(TweenOneGroup2, (0, import_extends5.default)({}, props, { className: classNames, enter: function enter2(e) {
...
var TextyAnim_default = TextyAnim;
...
var es_default = TextyAnim_default;
export {
  es_default as default
};
//# sourceMappingURL=rc-texty.js.map
